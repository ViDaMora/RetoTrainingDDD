...
public class AsignarMilitar implements Command {
    ...
    public AsignarMilitar(UnidadMilitarId unidadMilitarId, MilitarId militarId, Nombre nombre, Nacionalidad nacionalidad,
                          Edad edad, Autoridad autoridad, Genero genero) {
